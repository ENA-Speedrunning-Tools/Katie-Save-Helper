    ...
    public class LoadSavePatch
    {
        ...
        static bool Prefix(int index)
        {
            try
            {
                ...
                if (readSuccess && dataProp != null)
                {
                    ...
                    if (dataValue != null)
                    {
                        if (KatieSaveHelperMod.forceCustomSeedOnLoad)
                        {
                            ...
                            KatieSaveHelperMod.mls.LogInfo($"Loaded Save {index} with seed {KatieSaveHelperMod.customSeed}");
                        }
                ...
                {
                    KatieSaveHelperMod.mls.LogInfo("CurrentSaveLoaded event not invoked");
                }
            ...
            {
                KatieSaveHelperMod.mls.LogError(e);
                return true;
            }
        }
    }
