...
namespace KatieSaveHelper
{
    ...
    public class KatieSetting<T> : IKatieSetting
    {
        ...
        {
            Config.Value = KatieSaveHelperModConfig.configCategory.CreateEntry(InternalName, DefaultValue, description);
        }
    ...
    public class KatieAction : IKatieActionBase
    {
        ...
        {
            Config.Key = KatieSaveHelperModConfig.configCategory.CreateEntry($"{InternalName}_Key", DefaultKey, $"Key used to {description}");
        }
    ...
    public class KatieTransitionAction : IKatieActionBase
    {
        ...
        public void CreateTransitionConfigEntry()
        {
            ...
            Config.Transition.Type = KatieSaveHelperModConfig.configCategory.CreateEntry($"{name}_TransitionType", DefaultTransition.Type, $"Transition type to use for the '{DisplayName}' action's transition");
            Config.Transition.Color = KatieSaveHelperModConfig.configCategory.CreateEntry($"{name}_TransitionColor", KatieUtil.GetHexFromColor(DefaultTransition.Color), $"Transition color to use for the '{DisplayName}' action's transition");
            Config.Transition.FadeInTime = KatieSaveHelperModConfig.configCategory.CreateEntry($"{name}_TransitionFadeInTime", DefaultTransition.FadeInTime, $"Transition fade-in time to use for the '{DisplayName}' action's transition");
            Config.Transition.FadeOutTime = KatieSaveHelperModConfig.configCategory.CreateEntry($"{name}_TransitionFadeOutTime", DefaultTransition.FadeOutTime, $"Transition fade-out time to use for the '{DisplayName}' action's transition");
        }
