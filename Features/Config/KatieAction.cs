...
namespace KatieSaveHelper
{
    ...
    public class KatieAction : IKatieActionBase
    {
        ...
        {
            Config.Key = KatieConfig.configCategory.CreateEntry($"{InternalName}_Key", DefaultKey, $"Key used to {description}");
        }
    ...
    public class KatieTransitionAction : IKatieActionBase
    {
        ...
        public void CreateTransitionConfigEntry()
        {
            ...
            Config.Transition.Type = KatieConfig.configCategory.CreateEntry($"{name}_TransitionType", DefaultTransition.Type, $"Transition type to use for the '{DisplayName}' action's transition");
            Config.Transition.Color = KatieConfig.configCategory.CreateEntry($"{name}_TransitionColor", KatieUtil.GetHexFromColor(DefaultTransition.Color), $"Transition color to use for the '{DisplayName}' action's transition");
            Config.Transition.FadeInTime = KatieConfig.configCategory.CreateEntry($"{name}_TransitionFadeInTime", DefaultTransition.FadeInTime, $"Transition fade-in time to use for the '{DisplayName}' action's transition");
            Config.Transition.FadeOutTime = KatieConfig.configCategory.CreateEntry($"{name}_TransitionFadeOutTime", DefaultTransition.FadeOutTime, $"Transition fade-out time to use for the '{DisplayName}' action's transition");
        }
